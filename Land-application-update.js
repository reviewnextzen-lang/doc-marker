...
function openLandApModal() {
    if(typeof setActiveMode === "function") setActiveMode('mode-landap-maker');
    document.getElementById('landapMakerModal').style.display = 'flex';
    setGdLang(gdLang);
}

function closeLandApModal() {
    document.getElementById('landapMakerModal').style.display = 'none';
}
...
function setLandLang(lang){
    ...
    window.currentLandKey = firstKey;
