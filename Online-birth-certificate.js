...
function renderBirthGrid() {
    const container = document.getElementById("seba-master-birth");
    container.innerHTML = "";

    onlineBirthList.forEach((seba, index) => {
        const card = document.createElement("div");
        card.className = "seba-card-item";
        card.style.background = birthGradients[index % birthGradients.length];
