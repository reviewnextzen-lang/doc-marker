...
const lawTemplates = {
	...
	bn: {
		...
		land_recovery: {
			...
			ডাকঘর {{occupierPost}},
			থানা {{occupierThana}},
			জেলা {{occupierDistrict}}

			ব্যক্তি ও তার সহযোগীরা বেআইনিভাবে
			আমার জমি জবরদখল করে এবং সেখানে
			{{occupationType}} শুরু করে।
	...
	en: {
		...
		land_recovery: {
			...
			But on {{problemDate}},
			{{occupier}},
			son of {{occupierFather}},
			village {{occupierVillage}},
			post office {{occupierPost}},
			police station {{occupierThana}},
			district {{occupierDistrict}}

			illegally occupied my land and started
			{{occupationType}} there.

			Although I tried to solve the matter locally,
			they did not agree to any settlement.

			Therefore, I request you to investigate the matter
			and take necessary legal action to restore my lawful possession.
			`
